...
@Slf4j
public class FeignDSBulkSendSourceDataClientConfiguration {
	...
	public BasicAuthRequestInterceptor basicDSAppDataAuthRequestInterceptor(@Autowired DSCacheManager dsCacheManager) {
		...
		String basicAuthUserName = dsCacheManager.prepareAndRequestCacheDataByKeyAndReference(
				PropertyCacheConstants.BASICAUTH_DSBULKSENDSOURCEDATA_USERNAME, PropertyCacheConstants.DBSERVICE_REFERENCE_NAME);
		String basicAuthUserPassword = dsCacheManager.prepareAndRequestCacheDataByKeyAndReference(
				PropertyCacheConstants.BASICAUTH_DSBULKSENDSOURCEDATA_PASSWORD, PropertyCacheConstants.DBSERVICE_REFERENCE_NAME);

		log.info("To call DSBulkSendSourceData, basicAuthUserName is {}, basicAuthUserPassword is {}", basicAuthUserName,
