    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(com.ds.proserv.connect.domain.APIService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.ds.proserv.connect.domain.APIService.class.getResource(".");
