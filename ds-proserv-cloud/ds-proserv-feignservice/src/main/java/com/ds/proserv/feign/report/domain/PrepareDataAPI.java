...
@JsonPropertyOrder({ "apiId", "apiUri", "apiNextPaginationPath", "apiDataTableName", "apiTotalSetSizePath",
		"apiResultSetSizePath", "apiCategory", "apiOperationType", "apiContentType", "apiAcceptType", "saveDataInCache",
		"apiParams", "commonFilters", "outputColumns", "filterAccountIds", "apiRunArgs" })
public class PrepareDataAPI implements IDocuSignInformation {
	...
	@JsonProperty("apiResultSetSizePath")
	private String apiResultSetSizePath;
