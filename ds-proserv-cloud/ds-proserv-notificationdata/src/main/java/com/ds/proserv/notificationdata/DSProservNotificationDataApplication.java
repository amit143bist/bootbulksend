package com.ds.proserv.notificationdata;
...
public class DSProservNotificationDataApplication {

	public static void main(String[] args) {
		SpringApplication.run(DSProservNotificationDataApplication.class, args);
	}
