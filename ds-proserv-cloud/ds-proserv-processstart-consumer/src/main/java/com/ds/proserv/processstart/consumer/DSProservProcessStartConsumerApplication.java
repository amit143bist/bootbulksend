package com.ds.proserv.processstart.consumer;
...
public class DSProservProcessStartConsumerApplication {

	public static void main(String[] args) {
		SpringApplication.run(DSProservProcessStartConsumerApplication.class, args);
	}
